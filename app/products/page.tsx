...
function buildProductsMetadata(searchParams?: {
  ...
  const baseTitle =
    titleParts.length > 0
      ? `${titleParts.join(" | ")} Products | Vape Ustad`
      : "Products | Vape Ustad";
  ...
  const description = `${descriptionParts.join(", ")}. Explore devices, coils, e-liquids, disposables, and more with a clean shopping experience at Vape Ustad.`;
